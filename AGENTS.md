...
- **MANDATORY:** After every significant change, you MUST:
  ...
  4. Log important changes by creating a new entry in `docs/40_Experiments/logs/YYYY-MM-DD_title.md`.
  5. Update the index in `docs/40_Experiments/AI_DEV_LOG.md` with the link to the new entry.
  6. Commit code AND documentation changes together.
