...
2.  **Estilo de Código Backend (Python):**
...
3.  **Estilo de Código Frontend (React/TypeScript):**
...
4.  **Documentación Viva (RAG + Obsidian) - CRÍTICO - Knowledge Base:**
    ...
    - **OBLIGATORIO:** Después de cada cambio significativo, el agente DEBE:
      ...
      4. Registrar cambios importantes creando una nueva entrada en `docs/40_Experiments/logs/YYYY-MM-DD_titulo.md`
      5. Actualizar el índice en `docs/40_Experiments/AI_DEV_LOG.md` con el enlace a la nueva entrada
      6. Hacer commit de los cambios de código Y documentación juntos
    - **Antes de hacer commit:** Verifica que:
      ...
      - Has creado el log correspondiente en `docs/40_Experiments/logs/` y actualizado el índice
...
5.  **Terminología Prohibida vs. Correcta:**
...
6.  **Versionado Automático (CRÍTICO):**
