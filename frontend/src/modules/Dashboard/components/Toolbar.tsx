...
export const Toolbar: React.FC<ToolbarProps> = ({ onToggleTimeline, timelineOpen = false }) => {
  ...
  return (
    <div className="absolute top-4 left-4 z-30 pointer-events-none">
      <GlassPanel className="pointer-events-auto flex items-center p-1.5 gap-3">
        {/* Botón Timeline */}
        {onToggleTimeline && (
          <>
            <button
        ...
        {/* Panel Principal: Play/Pause + Reset + Paso Actual */}
        ...
        {/* Panel Secundario: FPS + Partículas + Live Feed */}
