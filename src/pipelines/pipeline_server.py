...
async def _process_pth_upload(filename, file_data, form_fields):
    ...
    try:
        ...
        # Guardar archivo .pth
        # Asegurar que tenga un nombre que el sistema reconozca (ej. checkpoint_ep0.pth)
        # O mantener el original si ya tiene formato compatible.
        # Por simplicidad, guardamos como best_checkpoint.pth si no tiene info de episodio
